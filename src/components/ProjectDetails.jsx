...
const ProjectDetails = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex flex-col md:flex-row gap-8 items-center">
          <div className="w-full md:w-1/3 lg:w-1/4 flex-shrink-0">
            <div className="bg-white dark:bg-gray-800 rounded-2xl aspect-square flex items-center justify-center p-6 shadow-lg overflow-hidden">
              <img 
                src={project.image} 
                alt={project.name} 
      ...
      <motion.div 
        variants={fadeIn}
        className="bg-white dark:bg-gray-800 rounded-3xl p-8 mb-12 shadow-sm border border-gray-100 dark:border-gray-700"
      >
        <h2 className="text-3xl font-bold mb-6 text-primary">Project Story</h2>
        <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">{project.story}</p>
      </motion.div>
      ...
      >
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            ...
            <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">{project.problem}</p>
          </div>
          <div>
            <h2 className="text-3xl font-bold mb-6 text-primary">My Solution</h2>
            <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">{project.objective}</p>
          </div>
        </div>
      </motion.div>
        ...
        >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {project.metrics.map((metric, i) => (
              ...
              >
                <p className="text-gray-700 dark:text-gray-300">{metric}</p>
              </motion.div>
            ))}
          </div>
        </motion.div>
      ...
      >
        ...
        <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">{project.conclusion}</p>
      </motion.div>
