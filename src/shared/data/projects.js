...
// Single source of truth — desktop and mobile both import from here.
...
const projects = [
  {
    ...
    description:
      "A production-ready Android ERP system for repair shops. Digitizes customer tracking, automated SMS updates, and Bluetooth thermal printing for real-world business operations.",
    ...
    github: "https://github.com/shahajalal-mahmud/RepairStoreManager",
    live: "https://drive.google.com/file/d/1m7_lfMzOZHbpO7EsQEGvl3I9crFPEuTQ/view?usp=sharing",
    story:
      "Witnessing local repair shops struggle with manual paper ledgers and lost customer stickers, I built a digital-first solution. Unlike generic apps, this was built in the 'trenches' with feedback from 5 active shop owners to handle real-world chaos like dual-SIM SMS and thermal printer pairing.",
    features: [
    ...
    documentation:
      "Complete system workflow, hardware integration guides, and MVVM architecture breakdown available in GitHub Wiki.",
    readme:
      "Comprehensive guide covering Firebase setup, Bluetooth pairing logic, and APK installation.",
    problem:
      "Small repair shops face a 40% customer churn rate due to lost records and lack of communication during the repair lifecycle.",
    objective:
      "To provide an affordable, hardware-compatible ERP that automates the entire repair shop workflow on a mobile device.",
    scope:
      "Targeted at mobile/computer repair SMEs in Bangladesh; architecture designed for multi-branch scalability.",
    flowchart: "/projects/repair-store/system_workflow.png",
    architecture:
      "MVVM with Repository Pattern: Jetpack Compose (UI), Kotlin Coroutines (Async), Firestore (NoSQL), WorkManager (Background Tasks).",
    challenges: [
    ...
    contributions:
      "Solo Founder & Developer - Conducted market research, designed System Design, developed full-stack Android app, and managed beta testing for 5 shops.",
    future: [
    ...
    conclusion:
      "Validated by real-world usage across multiple shops; proven to reduce administrative overhead by 60% and eliminate paper-based record errors.",
    metrics: [
  ...
  },
  {
    ...
    description:
      "An AI-powered career guidance app that helps students discover personalized career paths with mentorship support, addressing career confusion in Bangladesh.",
    ...
    github: "https://github.com/shahajalal-mahmud/Prodorshok",
    live: "https://drive.google.com/file/d/1f74Z32Zrevh6W5p_Rp-MG6c1_3o33AVy/view?usp=sharing",
    story:
      "Born from personal struggles with career choices in Bangladesh. After surveying 150+ students across 10 universities, I built this to democratize career guidance beyond traditional paths like medicine/engineering.",
    features: [
    ...
    problem:
      "65% of students regret academic choices due to societal pressure; lack of accessible mentors.",
    objective:
      "Combine AI analysis with human mentorship to reveal diverse career opportunities.",
    scope: "Initially targets Bangladeshi high school/university students.",
    flowchart: "Documented in /docs/flowchart.pdf",
    architecture:
      "MVVM with Firebase backend, Deepseek R1 API, Jetpack Compose UI",
    challenges: [
    ...
    contributions:
      "Solo Project - Conceived, designed, and developed all components.",
    future: [
    ...
    conclusion:
      "Early testing shows 82% of users found new career options they hadn't considered.",
    metrics: [
  ...
  },
  {
    ...
    description:
      "An AI-powered computer vision app built for the SOLVIO Hackathon 2025. Detects counterfeit Bangladeshi banknotes in real-time with 98.7% accuracy using on-device machine learning.",
    ...
    documentation:
      "Extensive technical documentation including dataset preparation (1000+ images) and system architecture diagrams.",
    readme:
      "Full setup guide for Android Studio, TFLite model integration, and hardware requirements.",
    problem:
      "Small merchants and individuals in Bangladesh lose millions annually to counterfeit notes because they lack professional detection tools.",
    objective:
      "Democratize financial security by providing a 98% accurate detection tool accessible to anyone with a smartphone.",
    scope:
      "Currently optimized for 200 Taka notes; architecture ready for all Bangladeshi denominations.",
    flowchart: "/projects/cashguard/system_workflow.png",
    architecture:
      "Convolutional Neural Network (CNN) deployed via TensorFlow Lite. UI built with Jetpack Compose using a 3-tier architecture (Camera Input -> Processing -> AI Classification).",
    challenges: [
    ...
    contributions:
      "Project Lead & Android Developer - Architected the CameraX-TFLite pipeline, designed the modern M3 interface, and optimized the classification logic for real-time performance.",
    future: [
    ...
    conclusion:
      "Ranked as a top-tier project in SOLVIO 2025, proving that on-device AI can effectively solve high-impact financial security challenges in developing nations.",
    metrics: [
  ...
  },
  {
    ...
    description:
      "A fully dynamic personal portfolio website tailored for university teachers, featuring a real-time Firestore backend and secure admin dashboard.",
    ...
    github: "https://github.com/shahajalal-mahmud/portfolio-nag-sir",
    live: "https://anindyanag.netlify.app/",
    story:
      "A university teacher needed to showcase research and publications without touching code. I built this to explore fullstack React while solving a real administrative need.",
    features: [
    ...
    problem:
      "Academic professionals often lack the technical skills to maintain updated digital profiles.",
    objective: "Create a zero-coding content management experience for educators.",
    scope:
      "Designed for academic professionals but adaptable for any CV-heavy profile.",
    ...
    contributions:
      "Solo project – planned, designed, developed, and deployed.",
    future: [
      "Markdown-based publication import",
      "Google Scholar API integration",
    ],
    conclusion:
      "Successfully empowered a non-technical teacher to manage an elegant academic presence.",
    metrics: [
...
export const getProjectSlugs = () => projects.map((p) => ({ slug: p.slug }));
